...
| 2. Git 与资产边界 | 已完成 | 已有提交 `128671e`、`ed2f463`、`b16a84c`；根目录 `model/...` 是运行资产源；产物被 `.gitignore` 收住 | 仅在新实验/文档改动后提交 |
...
| 6. 正式实验设计 | 当前重点 | 需要固定多 seed、多 episode、扰动设置和统计口径 | 先建立 formal evaluation plan |
...
- **建立正式实验计划**
  ...
  - 将实验命令、模型版本、terrain 设置、扰动设置和结果表格写入独立文档。
